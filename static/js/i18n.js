...
const I18N = {
  zh: {
    ...
    'events.dismissed_at': '於 { {time} } dismiss',
    'events.dismissed_at_tooltip': 'dismiss 時間',
    ...
    'watchlists.created_at': '建立於 {date}',
    'watchlists.created_at_tooltip': '群組建立時間',
    ...
    'system.desc_prefix': '即時顯示 Stocker 應用嘅健康狀態、業務指標同 Prometheus 計數器。數據來自',
    'system.desc_plus': '+',
    'system.desc_suffix': '。',
  ...
  en: {
    ...
    'events.dismissed_at': 'Dismissed on {time}',
    'events.dismissed_at_tooltip': 'Dismissal timestamp',
    ...
    'watchlists.created_at': 'Created on {date}',
    'watchlists.created_at_tooltip': 'When this group was created',
    ...
    'system.desc_prefix': 'Live health, business metrics, and Prometheus counters for the Stocker app. Backed by',
    'system.desc_plus': '+',
    'system.desc_suffix': '.',
